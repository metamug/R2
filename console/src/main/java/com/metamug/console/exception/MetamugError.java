 ...
 */
package com.metamug.console.exception;
...
public enum MetamugError {
     ...
     * Sets error-code 100
     */
    APP_CREATE_LIMIT_EXCEEDED("App creation limit exceeded"),
    /**
     * Sets error-code 101
     */
     ...
     * Sets error-code 102
     */
    CLASS_NAME_EXISTS("Classname already exist reupload the project with different 'className' for execution"),
    /**
     * Sets error-code 103
     */
     ...
     * Sets error-code 104
     */
    MAVEN_BUILD_FAILED("Failed to build maven project"),
    /**
     * Sets error-code 105
     *
     */
    MAVEN_DEPRECATED_DEPENDENCY_VERSION("Project contains deprecated dependency. Use latest dependency version: 1.5"),
    /**
     * Sets error-code 106
     */
    MAVEN_MISSING_DEPENDENCY("mtg-api dependency has not been implemented"),
    /**
     *
     */
    NON_PREMIUM_USER("You need to be a premium user to use this feature"),
    /**
     * Sets error-code 108
     */
    RESOURCE_FILE_NAME_INVALID("Resource file name is invalid"),
    /**
     * Sets error-code 109
     */
     ...
     * Sets error-code 110
     */
    UNVERIFIED_USER("You don't have access to this feature"),
    /**
     * Sets error-code 111
     */
    UPLOAD_LISTENER_EXISTS("You already have an UploadListener in one of your uploaded project you can modify it or delete it to add new one."),
    /**
     * Sets error-code 112
     */
    DOWNLOAD_LISTENER_EXISTS("You already have an DownloadListener in one of your uploaded project you can modify it or delete it to add new one.");
