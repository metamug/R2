...
import com.metamug.console.daos.PasswordDAO;
...
//    public boolean sendResetCode(String emailId) throws AddressException, MessagingException, IOException {
//        String randomString = Util.randomString(10);
//        String password = BCrypt.hashpw(randomString, BCrypt.gensalt(12, SECURE_RANDOM));
//        int resultStatus = dao.resetPassword(password, emailId);
//        if (resultStatus > 0) {
//            StringBuilder contentBuilder = new StringBuilder();
//            try (BufferedReader in = new BufferedReader(new FileReader(PasswordService.class.getClassLoader().getResource("reset_password_mail.html").getFile()))) {
//                String str;
...
//            Util.sendMail(emailId, "Metamug Console Reset Password", content);
//            return true;
//        } else {
//            return false;
//        }
//    }
    public boolean changePassword(int userId, String oldPassword, String newPassword) throws IOException, SQLException, PropertyVetoException, ClassNotFoundException {
        String newHashPassword = BCrypt.hashpw(newPassword, BCrypt.gensalt(12, SECURE_RANDOM));
        return dao.changePassword(userId, oldPassword, newHashPassword) > 0;
    }
}
