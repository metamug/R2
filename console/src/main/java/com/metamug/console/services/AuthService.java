...
public class AuthService {
    ...
    public JSONObject generateTokenByActivationCode(String emailId, String activationCode, String ip, String deviceType) {
        return dao.generateTokenByActivationCode(emailId, activationCode, ip, deviceType);
    }
}
