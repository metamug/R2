...
import static com.metamug.console.util.Util.MAX_MEMORY_SIZE;
import static com.metamug.console.util.Util.MAX_REQUEST_SIZE;
import java.io.File;
...
public class RequestUtil {
    public static File getUploadedFile(HttpServletRequest request) throws FileUploadException, Exception{
