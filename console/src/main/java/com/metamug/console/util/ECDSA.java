...
public class ECDSA {
    ...
    public static boolean verify(JSONObject obj) throws NoSuchAlgorithmException, InvalidKeyException, InvalidKeySpecException, UnsupportedEncodingException, SignatureException{
