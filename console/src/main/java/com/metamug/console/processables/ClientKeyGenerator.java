...
import com.metamug.console.client.ClientKeyPair;
import com.metamug.console.util.ECDSA;
 ...
 */
public class ClientKeyGenerator implements RequestProcessable{

    @Override
    public Response process(Request req, DataSource ds, Map<String, Object> map) throws Exception {
        KeyPair keys = ECDSA.generate();
        
        return new Response(new ClientKeyPair(keys.getPublic(),keys.getPrivate()));   
    }
}
