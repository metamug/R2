...
import static com.metamug.console.backend.ConfigManager.testConnection;
 ...
 */
public class TestDsConnection implements RequestProcessable {

    @Override
    public Response process(Request req, DataSource ds, Map<String, Object> arg) throws Exception {
        String dbType = req.getParameter("type");
        String dbUrl = req.getParameter("url");
        String dbUser = req.getParameter("username");
        String dbPass = req.getParameter("password");
        
        boolean success = testConnection(dbType, dbUrl, dbUser, dbPass);
