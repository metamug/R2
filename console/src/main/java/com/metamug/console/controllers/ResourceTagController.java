...
import com.metamug.console.services.ResourceTagService;
 ...
 */
@WebServlet(name = "ResourceTagController", urlPatterns = {"/resourcetag"})
public class ResourceTagController extends HttpServlet {
    
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        ResourceTagService rts = new ResourceTagService();
        JSONObject data = new JSONObject();
        try {
            data = rts.getTags();
        } catch (SQLException | PropertyVetoException | ClassNotFoundException ex) {
            Logger.getLogger(ResourceTagController.class.getName()).log(Level.SEVERE, null, ex);
        }
