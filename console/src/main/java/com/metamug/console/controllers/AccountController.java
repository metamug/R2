...
public class AccountController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String activity = request.getParameter("act") == null ? "" : request.getParameter("act");
        String emailId = request.getParameter("id") == null ? "" : request.getParameter("id");
        String activationCode = request.getParameter("token") == null ? "" : request.getParameter("token");
        AuthService authService = new AuthService();
        UserService userService = new UserService();
        try {
            //URL: ../account/{activationCode
            if (!activationCode.isEmpty() && !emailId.isEmpty()) {
//                boolean success = userService.verifyAccount(emailId, activationCode);
//                if (success) {
//                    String deviceType = Utils.getDeviceType(request.getHeader("User-Agent"));
//                    obj = authService.generateTokenByActivationCode(emailId, activationCode, request.getRemoteAddr(), deviceType);
...
//                    obj.put("status", 401);
//                }
            } else if (activity.equalsIgnoreCase("verify") && !emailId.isEmpty()) {

//                String domain = (String)request.getAttribute("domain");
//                userService.sendActivationMail(domain.toString(), emailId);
//
//                response.setStatus(201);
            } else {
                ...
                if (token != null) {
                    ...
                    if (userId != 0) {
                        ...
                        obj = userService.getUserDetails(userId, request.getHeader("Authorization"));
                    } else {
                        response.setStatus(401);
...
//            Logger.getLogger(AccountController.class.getName()).log(Level.SEVERE, ex.getLocalizedMessage(), ex);
//        }
