...
public class UserController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (pathInfo != null) {
            ...
            if (userService.userExists(path[1].toLowerCase().trim())) {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            //Register the user
            if ((emailId != null && !emailId.trim().isEmpty()) && (orgName != null && !orgName.trim().isEmpty()) && !password.trim().isEmpty()) {
                if (Util.isValidEmailId(emailId)) {
                    String domain = (String)request.getAttribute("domain");
                    userService.register(new String(Base64.getDecoder().decode(password.trim().getBytes())), emailId.trim(), orgName.trim(), domain.toString());
            ...
            //Possible exception due to unique constraint on email-id
            ...
            obj.put("status", 422);
            obj.put("message", "Invalid Email-Id");
            Logger.getLogger(UserController.class.getName()).log(Level.SEVERE, ex.getMessage());
