 ...
 */
@WebServlet(name = "PropertiesController", urlPatterns = {"/properties"})
public class PropertiesController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        try {
            ...
            service.addProperty(appName, key, value, OUTPUT_FOLDER);
            
            response.setStatus(200);

        } catch (IOException | SQLException | PropertyVetoException | ClassNotFoundException ex) {
            response.setStatus(500);
            Logger.getLogger(PropertiesController.class.getName()).log(Level.SEVERE, ex.getLocalizedMessage(), ex);
...
/*
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        try {
            ...
            PropertiesService service = new PropertiesService();
            JSONObject properties = new JSONObject(requestBody.trim());
            
            service.updateProperties(appName, properties);
    ...
    protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        try {
            ...
            service.removeProperty(appName, key);
