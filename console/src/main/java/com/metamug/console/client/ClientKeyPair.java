 ...
 */
package com.metamug.console.client;
...
public class ClientKeyPair {
    ...
    public ClientKeyPair(PublicKey publicKey, PrivateKey privateKey) {
        access = Base64.getEncoder().encodeToString(publicKey.getEncoded());
        secret = Base64.getEncoder().encodeToString(privateKey.getEncoded());
    }
