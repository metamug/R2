...
public class ParserService {
     ...
     */
    private void printHeader(XMLStreamWriter writer) throws XMLStreamException, IOException {
        Date date = new Date();
        SimpleDateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");
        dateFormat.setTimeZone(TimeZone.getTimeZone("UTC"));
        writeUnescapedData("<%-- Generated by Metamug API Resource Parser - "
                + dateFormat.format(date) + " (UTC) --%>",output);
