...
public class ApiDocGenerator {
    ...
    public static void generate(String appDirectory) {
        ...
        try {
            ...
            OutputStream output = new FileOutputStream(appDirectory + "/index" + ".html");
            XMLStreamWriter writer = new IndentingXMLStreamWriter(factory.createXMLStreamWriter(output, "UTF-8"));
            ...
            writeEscapedCharacters("Welcome",writer,output);
            ...
            writeEscapedCharacters("Resource List:",writer,output);
            writer.writeEndElement();
            if (!htmlFilenameList.isEmpty()) {
                ...
                for (String name : htmlFilenameList) {
                    ...
                    writeEscapedCharacters(name,writer,output);
                ...
                writeEscapedCharacters("No resources created!",writer,output);
    ...
    private static void writeEscapedCharacters(String data, XMLStreamWriter writer, OutputStream output)
