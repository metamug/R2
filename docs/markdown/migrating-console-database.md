...
--
-- Table structure for table console_script_file
--

DROP TABLE IF EXISTS console_script_file;
CREATE TABLE IF NOT EXISTS console_script_file (
  script_file_id BIGINT(20) NOT NULL AUTO_INCREMENT PRIMARY KEY,
  script_file_hash VARCHAR(64) COLLATE utf8mb4_unicode_ci NOT NULL UNIQUE,
  script_file_name VARCHAR(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  script_file_size VARCHAR(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  app_name VARCHAR(30) COLLATE utf8mb4_unicode_ci NOT NULL,
  user_id BIGINT(20) NOT NULL,
  uploaded_on TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  deleted_on TIMESTAMP NULL DEFAULT NULL,
  KEY script_file_name (script_file_name,app_name,user_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS error_log (
  ...
  error_id VARCHAR(25) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS console_update (
  ...
  update_complete TINYINT(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;
...
DROP TABLE IF EXISTS console_script_file;
CREATE TABLE console_script_file (
  script_file_id BIGSERIAL NOT NULL PRIMARY KEY,
  script_file_hash VARCHAR(64) NOT NULL UNIQUE,
  script_file_name VARCHAR(191) NOT NULL,
  script_file_size VARCHAR(10) NOT NULL,
  app_name VARCHAR(30)  NOT NULL,
  user_id BIGINT NOT NULL,
  uploaded_on TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  deleted_on TIMESTAMP NULL DEFAULT NULL
 );
CREATE INDEX console_script_file_index ON console_script_file(script_file_name,app_name,user_id);
...
CREATE TABLE console_update (
  ...
  update_complete boolean NOT NULL DEFAULT 'false'
);
